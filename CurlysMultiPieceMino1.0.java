...
public class CurlysMultiPieceMino {
   ...
   public boolean comprobarGiroCorrecto(Movible ficha1){
       ...
       boolean resultado=false;
       if(caraActual1!=-1&&caraActual2!=-1){
           if(ficha1.getLadoA()==caraActual1&&ficha1.getLadoC()==caraActual2&&ficha1.getPosicion()!=0){
               resultado=true;
           }else{
       ...
       //System.out.println(ficha1.getLadoA()+"=="+caraActual1+" "+ficha1.getLadoC()+"=="+caraActual2);
       //System.out.println("El resultado del giro es "+resultado);
       return resultado;
   }
   ...
   public int validarSiguienteFicha(Movible fichaValidar){
       ...
       //System.out.println("El valor de validacion de la siguiente ficha es: "+resultado);
               return resultado;
   }
    ...
    public void girarFichaCiclo(Movible fichaSeleccionada,String op){
         switch(op){
                case "Derecha":
            ...
            case "No":
                ...
                if(!fichaGirada){
                    System.out.println("La ficha no encaja en el tablero, siga girando hasta que encaje, por favor");
                }else{
    ...
    public void jugar(){
       ...
       imprimirFichasJugadas();
        ...
        while(verificarManoVacia()==0&&(verificarPozoVacio()==false&&movimientosDisponibles==true)){
            int fichaAJugar=0;
            ...
            System.out.println("El puntaje del jugador"+((turno)+1)+" :" +jugadores.get(turno).getPuntajeJugador());
        cambiarTurno();
        if(elPozo.getPozo().isEmpty())
            {
